...
int MyTime::Time_report() {
    cout << "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~" << endl;
    cout<<"Clients time = "<<double(clients_time)/CLOCKS_PER_SEC<<" s"<<endl;  //输出时间（单位：ｓ）
    cout<<"Server 0 time = "<<double(server_time_0)/CLOCKS_PER_SEC<<" s"<<endl;  //输出时间（单位：ｓ）
    cout<<"Server 1 time = "<<double(server_time_1)/CLOCKS_PER_SEC<<" s"<<endl;  //输出时间（单位：ｓ）
    cout<<"AC time = "<<double(controller_time)/CLOCKS_PER_SEC<<" s"<<endl;  //输出时间（单位：ｓ）
}
